...
public class ReplyController {
	...
	/*
	 * 댓글 글목록 구현하기 return List<ReplyVO> 참고: @ParhVariable는 URI의 경로에서 원하는 데이터를 추출하는
	 * 용도의 어노테이션. 현재 요청:http://localhost:8080/replies/all/게시판글번호.do 예전
	 * 요청:http://localhost:8080/replies/replyList.do?b_num=게시판글번호
	 */
	...
	/*
	 * 댓글 쓰기 구현하기 return String 참고: @requestBody
	 */
	 ...
	 * 댓글 삭제
	 * 
	 * @return 참고: rest 방식에서 update 작업은 put, path방식을 이용해서 처리. 전체 데이터를 수정하는 경우에는 put을
	 * 이용하고, 일부 데이터를 수정하는 경우에는 patch를 이용
	 */
	 ...
	 * 댓글 삭제 구현하기
	 * 
	 * @return 참고: rest 방식에서 delete작업은 delete방식을 이용해서 처리
	 */
